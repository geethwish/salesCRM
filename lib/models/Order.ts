...
import { Order as OrderInterface, OrderCategory, OrderSource } from '@/lib/types/order';
...
OrderSchema.statics.getStatsByUserId = function(userId: string | mongoose.Types.ObjectId) {
